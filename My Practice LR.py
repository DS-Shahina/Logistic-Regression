...
#Importing Data
claimants = pd.read_csv("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Logistic Regression/claimants.csv", sep = ",")
...
# from sklearn import metrics
fpr, tpr, thresholds = roc_curve(c1.ATTORNEY, pred) #It gives us FPR, TPR for different thresholds(cutoff)
...
optimal_threshold #0.5294418043694737
...
roc_auc = auc(fpr, tpr)
print("Area under the ROC curve : %f" % roc_auc) # 0.760101

# filling all the cells with zeroes
c1["pred"] = np.zeros(1340) # add new column "pred" with all zeros
# taking threshold value and above the prob value will be treated as correct value 
c1.loc[pred > optimal_threshold, "pred"] = 1 # if the value is greater than threshold value mark it as "1" otherwise "0"
# classification report
classification = classification_report(c1["pred"], c1["ATTORNEY"])
classification # support=accuracy=0.71
...
#summary
model.summary2() # for AIC  AIC:1177.6667 , BIC:1206.7292 
model.summary() #CLMAGE,SEATBELT are insignificant here, p-value is greater than 0.5
...
accuracy_test = (142 + 146)/(402) 
accuracy_test #0.7164179104477612
...
roc_auc_test #0.7662939732751569 - average model, it should greater than 0.8 
...
accuracy_train = (319 + 350)/(938)
print(accuracy_train) #0.7132196162046909

# train and test accuracy is close enough so it is good model we can say.
